        ...
        <CCard>
          ...
          <CCardBody>
            <CListGroup>
              ...
              <CListGroupItem disabled tag="button"
                >Disabled button
              </CListGroupItem>
    ...
    <CRow>
      ...
      <CCol md="6">
        <CCard>
          ...
          <CCardBody>
            <CListGroup accent>
              <CListGroupItem accent="light" href="#"
                >This is a default list group item
              </CListGroupItem>
              <CListGroupItem accent="primary" color="primary" href="#"
                >This is a primary list group item
              </CListGroupItem>
              <CListGroupItem accent="secondary" color="secondary" href="#"
                >This is a secondary list group item
              </CListGroupItem>
              <CListGroupItem accent="success" color="success" href="#"
                >This is a success list group item
              </CListGroupItem>
              <CListGroupItem accent="danger" color="danger" href="#"
                >This is a danger list group item
              </CListGroupItem>
              <CListGroupItem accent="warning" color="warning" href="#"
                >This is a warning list group item
              </CListGroupItem>
              <CListGroupItem accent="info" color="info" href="#"
                >This is a info list group item
              </CListGroupItem>
              <CListGroupItem accent="light" color="light" href="#"
                >This is a light list group item
              </CListGroupItem>
              <CListGroupItem accent="dark" color="dark" href="#"
                >This is a dark list group item
              </CListGroupItem>
            </CListGroup>
          </CCardBody>
        ...
        <CCard>
          ...
          <CCardBody>
            <CListGroup>
              ...
              <CListGroupItem class="flex-column align-items-start" href="#">
                <div class="d-flex w-100 justify-content-between">
                  <h5 class="mb-1">List group item heading</h5>
